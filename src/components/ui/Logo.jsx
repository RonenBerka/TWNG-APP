...
export default function Logo({ size = 32, color, showBeta = false }) {
  const fillColor = color || T.txt;
  // The real logo SVG has viewBox 0 0 188.724 109.697 (≈1.72:1 ratio)
  const height = size;
  const width = Math.round(size * 1.72);
    ...
    <div style={{ display: "inline-flex", alignItems: "center", gap: "8px" }}>
      ...
      {showBeta && (
        <span style={{
          ...
          color: T.txtM, fontFamily: "'JetBrains Mono', monospace",
        }}>
          BETA
        </span>
      )}
